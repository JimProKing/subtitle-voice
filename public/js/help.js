export const HELP = {
  ...
  voice: '성별과 연령을 고릅니다. 남성은 인준, 여성은 선희, 중성은 현수 목소리입니다. 연령은 아이·청년·중년·노년으로 높낮이와 빠르기가 달라집니다.',
  ...
  gender: '남성은 남성 한국어, 여성은 여성 한국어, 중성은 다른 남성 목소리입니다.',
  age: '아이, 청년, 중년, 노년을 고르면 같은 성별 안에서 높낮이와 빠르기가 달라집니다.',
